...
DEFAULT_YOLO_MODEL_PATH = os.path.join(os.path.dirname(__file__), "models", "yolov8n.pt")
YOLO_MODEL_PATH = str(os.getenv("CAMERA_YOLO_MODEL", DEFAULT_YOLO_MODEL_PATH) or "").strip() or DEFAULT_YOLO_MODEL_PATH
