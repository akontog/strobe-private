...
Η πρώτη ταινία στην οποία εφαρμόστηκε η τεχνική που θα συζητηθεί στην συνέχεια είναι το Waterworld του 1995. Υλοποιήθηκε σε fortran από τον καθηγητή οπτικής υπολογιστικής (Visual Computing) του πανεπιστημίου του Clempson Jerry Tessendorf. Δύο χρόνια αργότερα, το 1997, η ακριβότερη, μέχρι εκείνη την στιγμή, κινηματογραφική παραγωγή, ο Τιτανίκος, χρησιμοποίησε στις σκηνές ανοιχτής θάλασσας την ίδια τεχνική. Στην ταινία "The Perfect Storm" η τεχνική πέτυχε να απεικονίσει σκηνές με πολύ φουρτουνιασμένη θάλασσα.
...
#### 2.3 Δραστηριότητα: Άθροισμα κυμάτων διαφορετικών συχνοτήτων
