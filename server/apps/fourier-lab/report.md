...
Αναλυτικό report της παρουσίασης, με αρίθμηση και σειρά ίδιες με το τρέχον deck.
...
Οι μαθητές προβλέπουν πώς θα μοιάζει το τελικό φάσμα αφού αναμειχθούν συνιστώσες. Η πρόβλεψη πριν την απεικόνιση ενισχύει την εννοιολογική κατανόηση.

### 7.2 Από το σήμα στο φάσμα (Fourier Transform)
...
### 7.3 FFT Duel: Βρες τη συχνότητα
Διαδραστικό παιχνίδι ταχύτητας για αναγνώριση κυρίαρχης συχνότητας. Η άσκηση λειτουργεί ως επανάληψη με στοιχείο ανταγωνισμού.
...
### 7.5 Τι κάνει ο απλός Fourier Transform (DFT)
...
### 7.6 Τι κάνει ο αντίστροφος μετασχηματισμός (IDFT/IFFT)
...
### 7.7 Παράδειγμα απλού DFT -> IFFT σε ήχο
