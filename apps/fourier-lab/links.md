...
- [But what is a Fourier Transform](https://www.3blue1brown.com/lessons/fourier-transforms/)
...
- [MATHEMATICS OF THE DISCRETE FOURIER TRANSFORM (DFT) WITH AUDIO APPLICATIONS SECOND EDITION - Καλές σημειώσεις](https://ccrma.stanford.edu/~jos/mdft/)
...
- [άρθρο από GPU Gems](https://developer.nvidia.com/gpugems/gpugems/part-i-natural-effects/chapter-1-effective-water-simulation-physical-models)
