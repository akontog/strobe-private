...
- να υπάρχει διαχωρισμός (χρωματικός;) μεταξύ δραστηριοτήτων. Ίσως στα χρώματα του λογοτύπου ώστε να βλέπουν άμεσα ότι βρίσκονται στην ίδια δραστηριότητα με τον δάσκαλο/εποπτικό μέσο
![λογότυπο](strobe.svg)
