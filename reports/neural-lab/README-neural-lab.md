...
# bias (ανδρέας)
## Με bias Στην πρώτη εκδοχή,  ο κανόνας είναι σκορ > 0 →Μέσα
σκορ < 0 → Έξω σκορ = είσοδος x βάρος + τιμή (bias) Παράδειγμα στη μία διασταση:Ποδήλατα (2 ρόδες)
Αυτοκίνητα (4 ρόδες)
Πατίνια (4 ρόδες)
Φορτηγά (6 ρόδες)
Θέλουμε να διακρίνουμε/επιλέξουμε φορτηγά:
βάρος = 1, bias = -5
Θέλουμε να διακρίνουμε/επιλέξουμε ποδήλατα:βάρος = -1, bias = +3
...
Αν ΔΕΝ έχουμε bias, τότε το threshold to δίνουμε εμείς (όπως στο paper). Αυτό παιδαγωγικά είνια σωστό γιατί είναι scaffolding/υποστήριξη του μαθητή, ο οποίος παλεύει μόνο με το βάρος.
